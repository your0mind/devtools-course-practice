...
class LMetricsFloat {
 public:
    ...
    static float l3_vec_distance(const std::vector<float>& vec1, const std::vector<float>& vec2);
    static float l4_vec_distance(const std::vector<float>& vec1, const std::vector<float>& vec2);
 private:
    static std::vector<float> vec_substract_mod(const std::vector<float> vec1, const std::vector<float> vec2);
};
