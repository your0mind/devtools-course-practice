...
class Calculation_Rent{
 public:
        Calculation_Rent() {}
        ~Calculation_Rent() {}
        double Rent_Accum_Year_postnumerando_hard_rate(double amount_payment,
                                double rent_term, double interest_rate);
        double Rent_Accum_Year_postnumerando_easy_rate(double amount_payment,
                                double rent_term, double interest_rate);
        double Rent_Accum_Year_prenumerando_hard_rate(double amount_payment,
                                double rent_term, double interest_rate);
        ...
        double Rent_Modern_Year_postnumerando_hard_rate(double amount_payment,
                double rent_term, double interest_rate);
        double Rent_Modern_Year_postnumerando_easy_rate(double amount_payment,
                double rent_term, double interest_rate);
        double Rent_Modern_Year_prenumerando_hard_rate(double amount_payment,
                double rent_term, double interest_rate);
