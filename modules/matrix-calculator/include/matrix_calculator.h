...
#ifndef MODULES_MATRIX_CALCULATOR_INCLUDE_COMPLEX_CALCULATOR_H_
...
private:
	...
	MatrixCalculator Prepare_for_minores(int, std::vector<std::vector<double > >, int, int) const;
	MatrixCalculator Transpon(int) const;
};

#endif  // MODULES_MATRIX_CALCULATOR_INCLUDE_COMPLEX_CALCULATOR_H_