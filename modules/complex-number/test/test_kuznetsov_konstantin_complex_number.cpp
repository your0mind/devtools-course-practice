...
TEST(Kuznetsov_Konstantin_ComplexNumberTest, New_Complex_Number_Is_Set_To_Zero) {
    ComplexNumber z;
...
TEST(Kuznetsov_Konstantin_ComplexNumberTest, Can_Create_Number_Using_An_Operation) {
    double re1 = 1.0;
    double im1 = 1.0;
    double re2 = 2.0;
    double im2 = 2.0;
...
TEST(Kuznetsov_Konstantin_ComplexNumberTest, Can_Get_Re_And_Im_Using_Conjugate) {
    double re = 2.0;
    double im = 3.0;
